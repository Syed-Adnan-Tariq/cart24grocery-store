        ...
        <div class="panel panel-default ">
            <div class="panel-heading">
                ...
                <button class="btn btn-success ">
                    <em class="fa fa-chevron-circle-right"><strong> {{$recipe}} </strong></em>
                </button>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" id="top_pad">
                                            <a href="/admin/recipe/{{$recipe->id}}" class="btn btn-success "><span class="glyphicon glyphicon-eye-open"></span></a>
                                            <a href="{{route('admin.recipe_edit',$recipe->id)}}" class="btn btn-primary "><span class="glyphicon glyphicon-pencil"></span></a>
                                            <a href="{{route('admin.recipe_trash',$recipe->id)}}" class="btn btn-warning "> <span class="glyphicon glyphicon-trash"></span></a>
                                        </div>
                                    </td>
                                </tr>
                                @endif
